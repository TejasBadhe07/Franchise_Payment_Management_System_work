...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    const points = parseFloat(pointsField.value);
    ...
    fetch(apiUrl, {
        ...
        .then((data) => {
        if (data.message) {
            const action = transactionType === "add" ? "Added ✅" : "Withdrawn ⚠️";
            Swal.fire({
                title: `${points} Points ${action}!`,
                text: `Panel: ${panelName}`,
                icon: transactionType === "add" ? "success" : "warning",
